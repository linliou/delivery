...
<HTML>
  <HEAD><TITLE>메뉴 정보 입력</TITLE></HEAD>
...
<div align=right>
	...
	<button onclick="location.href='FindMenubySIDforAdmin.jsp'">홈으로</button><br>
      </form>
   </div>
   </td>
</tr>
    ...
    <form name=form1 method=post action = UpdateMenu.jsp >
     <TABLE align=center valign=top border="1" cellpadding="8" cellspacing="0" bordercolor="#999999"> 
        ...
        <TR align=left bgcolor=white cellspacing=1 cellpadding=5 >
                  ...
                  <TD ><INPUT TYPE=text NAME=mname size=10 value="<%=mname %>" readonly  > </TD> 
        </TR>
        
        <TR align=left bgcolor=white cellspacing=1 cellpadding=5 >
                  <TD width=85>가격</TD>
                  <TD ><INPUT TYPE=text NAME=price size=10 value="<%=price %>" required > </TD> 
        </TR>
        <TR align=left bgcolor=white cellspacing=1 cellpadding=5 >
                  <TD width=85>소개</TD>
                  <TD ><INPUT TYPE=text NAME=intro size=20 value="<%=intro %>" required > </TD> 
        </TR>
	    <TR align=left bgcolor=white cellspacing=1 cellpadding=5 > 
		          <TD width=85>할인율</TD>
                  <TD  ><INPUT TYPE="text" NAME=sale size=10 value="<%=sale%>">예)20% -> 0.2</TD>
        </TR> 
        
	   </TABLE>
       <H4 align=center> <input type="submit" value=" 수정  " name="B1">
    </form>
  </BODY>
</HTML>   
