   ...
   <table border=1 width=320 align=center valign=top bgcolor=white cellspacing=1 cellpadding=1 bordercolor=black>
			   <input type="hidden" name="ONUM" value=<%=ONUM %>>
  			   ...
  			   <tr>
					<td>메뉴</td>
					  <td> 
					        현재 메뉴 : <%=rs.getString("mname") %>
               			 <%
               				String sname =	rs.getString("sname");
          		           Vector mnames = MyDB.selectDistinctMenu(sname); 
			    ...
			    <tr>
			    	<td>요구사항</td>
			    	<td>
			    	  현재 요구 사항 : <%=rs.getString("request") %>
			    	<textarea name="request" cols = "50" rows = "5"
     			  		placeholder="요구 사항을 남겨주세요."></textarea>
     			  	</td>
     			</tr>
     			<tr>
     				<td colspan=2 align="center">
     					<input type="submit" value=" 수  정 ">&emsp;&emsp;
