...
System.out.print("   >> clms : " + columns[i] + " " + columnTypes[i]+ "\n");   
     ...
     %>
      ...
      <table align=center valign=top border="1" cellpadding="8" cellspacing="0" bordercolor="#999999"> 
       <%      
       out.print("<script>function move(sname){document.location.href=\"GetMenuInfo.html?sname=\"+sname;     }</script>");
         ...
         //out.print("<th> <input type =\"button\" style=\"float:left\" value=\"메뉴 추가\" class=button onclick=\"move('"+sname+"')\"/>"+sname+" </td>");
         //out.print("</tr>" );
         %>
         <th>
               <form action = "GetMenuInfo.jsp" method="POST">
               <input type="hidden" name="sname" value=<%=sname %>>
               <input type="submit"style="float:left" value="메뉴 추가"><br>
               </form>
               </th>
         ...
         while(rs.next()) {
            ...
            for(int i=0; i<columns.length; i++){
               ...
               if (i==0){ if(cnt==0){   sname = obj.toString();
               //out.print("<th><form action = \"GetMenuInfo.jsp\" method=\"POST\"><input type=\"hidden\" name=\"sname\" value="+sname+
               //      "><input type=\"submit\" value=\"메뉴 추가\"><br></form></th>");
               %>
            ...
            <td>
               ...
               <input type="submit" style="float:left" value="메뉴 수정"><br>
               </form>
               </td>
