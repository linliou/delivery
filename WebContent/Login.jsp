    ...
    <%
                 ...
                 String id = request.getParameter("id");
                  ...
                  if (id == null || id.equals("")) {
              	 		out.println("<script language=javascript> alert('아이디가 입력되지지 않았습니다.'); window.history.go(-1); </script>");
                   		return;
                   } 
                  if (password == null || password.equals("")) {
              	 		out.println("<script language=javascript> alert('패스워드가 입력되지지 않았습니다.'); window.history.go(-1); </script>");
                   		return;
                   } 
                  ...
                  if (MyDB.isValidLogin(usertype, id, password)) {    
                      ...
                      if (usertype.equals("customer")) {
                         response.sendRedirect("CustomerStart.jsp");
             	 		...
             	 		out.println("<script language=javascript> alert('아이디 또는 패스워드가 잘못되었습니다'); window.history.go(-1); </script>");
                 		return;
